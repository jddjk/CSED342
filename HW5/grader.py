...
grader.addBasicPart('4a-1-basic', lambda : testBasic('expectiminimax'), 1, maxSeconds=maxSeconds, description='Tests expectiminimax for timeout on smallClassic.')
...
grader.addBasicPart('5a-1-basic', lambda : testBasic('alphabeta'), 1, description='Tests alphabeta for timeout on smallClassic.')
...
grader.addHiddenPart('6a-no-grading', lambda : testq6(0), 1, maxSeconds=300, description='No grading')
